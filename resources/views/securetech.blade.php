      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-features owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/featured-01.jpg" alt="">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-1.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-2.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-3.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-4.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-5.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-6.png" alt="">
                <div class="hover-effect">
                  <div class="content">
                    <h4>Walk In The Nature <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <span>(4.5)</span></h4>
                    <ul>
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/cctv-7.png" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="landpage/assets/images/featured-03.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="landpage/assets/images/icon-01.png" alt="">
              </div>
              <div class="right">
            ...
            <div class="thumb">
              <img src="landpage/assets/images/popular-01.png" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="landpage/assets/images/icon-02.png" alt="">
              </div>
              <div class="right">
            ...
            <div class="thumb">
              <img src="landpage/assets/images/popular-02.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="landpage/assets/images/icon-03.png" alt="">
              </div>
              <div class="right">
            ...
            <div class="thumb">
              <img src="landpage/assets/images/popular-03.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="landpage/assets/images/icon-04.png" alt="">
              </div>
              <div class="right">
            ...
            <div class="thumb">
              <img src="landpage/assets/images/popular-04.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
          ...
          <div class="owl-features owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="landpage/assets/images/closed-01.jpg" alt="">
            ...
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="landpage/assets/images/closed-02.jpg" alt="">
                  <span class="winner"><em>Winner:</em> Anthony Soft</span>
            ...
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="landpage/assets/images/closed-03.jpg" alt="">
                  <span class="winner"><em>Winner:</em> Anthony Soft</span>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="landpage/assets/images/pricing-01.jpg" alt="">
            <h4>Basic Plan</h4>
            <ul class="first-plan">
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="landpage/assets/images/pricing-02.jpg" alt="">
            <h4>Standard Plan</h4>
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="landpage/assets/images/pricing-03.jpg" alt="">
            <h4>Advanced Plan</h4>
            <ul class="third-plan">
              <li>Lorem Ipsum Dolores Sonte</li>
              <li>Songe Lorem Ipsum Dol</li>
